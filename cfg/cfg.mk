...
export CMP_OPTIONS :=
CMP_OPTIONS += -f $(FILELIST) -l $(SIM_LOG) -o $(EXEC_SIMV)
CMP_OPTIONS += +v2k +define+RTL_SAIF +notimingcheck +nospecify +vpi  +plusarg_save +nospecify +udpsched
...
clean:
	@-rm -rf $(SIM_PATH)/exec ucli.key csrc vc_hdrs.h novas.conf  novas_dump.log  novas.rc verdiLog *.log *.rc
